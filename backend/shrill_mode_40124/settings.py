"""
Django settings for shrill_mode_40124 project.
...
ROOT_URLCONF = 'shrill_mode_40124.urls'
...
WSGI_APPLICATION = 'shrill_mode_40124.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_mode_40124 API",
    "DESCRIPTION": "API documentation for shrill_mode_40124 App",
    "VERSION": "v1",
}
